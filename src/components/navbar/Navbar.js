    ...
    return (
        <>
            <div className="navHeader">
                ...
                <div className="unitedImage">
                    {/* not found image */}
                </div>
                <div className="languageSelector">
                    <select>
                        <option value="actual value 1">En</option>
                        <option value="actual value 2">Es</option>
                        <option value="actual value 3">Fr</option>
